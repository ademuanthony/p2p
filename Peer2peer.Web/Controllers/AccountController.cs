...
using Peer2peer.Web.Controllers.Results;
using Peer2peer.Web.Models.Account;
...
{
    public class AccountController : Peer2peerControllerBase
    {
        ...
        public async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "", string returnUrlHash = "")
        {
            ...
            if (string.IsNullOrWhiteSpace(returnUrl))
            {
                returnUrl = "/cp";// Request.ApplicationPath;
            }
